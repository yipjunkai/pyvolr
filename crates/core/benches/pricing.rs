...
//!
//! Production contracts only: the decision-record experiment harness
//! (F2 branchless cdf, F5 flag dispatch, F4/F4b serial-vs-rayon) lives in
//! `experiments.rs`, outside the gate.
